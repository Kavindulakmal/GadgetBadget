...
<ul>
  ...
  <li style="float:right"><a href="Items.jsp">Admin panal</a></li>
</ul>
		...
		<div class="row">
			<div class="col">
				...
				<form onsubmit ="return validateForm()" method='post' action='Items.jsp' id='formItem' name='formItem' >
					 ...
					 Confirm User password: <input type="password" id='Password2' name='Password' type='text' class='form-control col-md-3'><br>
