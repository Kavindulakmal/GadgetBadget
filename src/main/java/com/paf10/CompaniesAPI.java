 ...
 */
@WebServlet("/ItemsAPI")
public class CompaniesAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String output = itemObj.insertItem(
				request.getParameter("cliCode"),
				request.getParameter("cliEmail"),
				request.getParameter("cliBudget"),
				request.getParameter("cliDesc"),
				request.getParameter("cliCom"));
